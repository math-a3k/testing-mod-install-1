...
## Project Structure
    ...
    ├── testing_mod_install_1  # Django project configurations
...
1. Clone this repo and `cd testing_mod_install_1`
...
2. Clone this repo and `cd testing_mod_install_1`
